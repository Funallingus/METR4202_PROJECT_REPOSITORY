...
pixelCoords1 = int64(pixelCoords(1));
pixelCoords2 = int64(pixelCoords(2));
camMat14 = int64(camMatrix(1,4));
camMat13 = int64(camMatrix(1,3));
camMat24 = int64(camMatrix(2,4));
camMat23 = int64(camMatrix(2,3));

rhs1 = int64(pixelCoords1 - camMatrix(1,4) - camMatrix(1,3)*z);
rhs2 = int64(pixelCoords2 - camMatrix(2,4) - camMatrix(2,3)*z);
